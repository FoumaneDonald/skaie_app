...
export const routes: Routes = [
      ...
      // ── Admin ─────────────────────────────────────────────
      {
        ...
        children: [
          ...
          },
          {
            path: 'orders',
            loadComponent: () =>
              import('./features/order-list/order-list').then((m) => m.OrderList),
          },
          {
            path: 'orders/:id',
            loadComponent: () =>
    ...
    children: [
      {
        path: 'address',
        loadComponent: () =>
          import('./features/checkout-address/checkout-address').then((m) => m.CheckoutAddress),
      },
      {
        path: 'payment/:orderId',
        loadComponent: () =>
          import('./features/checkout-payment/checkout-payment').then((m) => m.CheckoutPayment),
      },
      {
        path: 'success/:orderId',
        loadComponent: () =>
          import('./features/payment-success/payment-success').then((m) => m.PaymentSuccess),
      },
    ],
  },
  ...
  // ── Résultat paiement Stripe (return_url) ───────────────────
  {
    ...
    canActivate: [verifiedGuard],
    loadComponent: () =>
      import('./features/payment-result/payment-result').then((m) => m.PaymentResult),
  },
